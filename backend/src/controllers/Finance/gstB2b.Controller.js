...
const TABLE = 'gst_b2b_sales';
const PK = 'b2b_id';

export const createGstB2b = async (req, res) => {
    try {
        const body = req.body || {};
...
export const getGstB2bById = async (req, res) => {
    try {
        ...
        console.error('Error fetching gst b2b by id:', error);
        res.status(500).json({ success: false, message: 'Error fetching record', error: error.message });
    }
};

export const updateGstB2b = async (req, res) => {
    try {
        const { id } = req.params;
        const body = req.body || {};
        const keys = Object.keys(body);
...
export const deleteGstB2b = async (req, res) => {
    try {
        ...
        console.error('Error deleting gst b2b:', error);
