...
const TABLE = 'gst_documents_issued';
const PK = 'document_id';
...
export const getAllGstDocuments = async (req, res) => {
    try {
...
export const getGstDocumentById = async (req, res) => {
    try {
        ...
        console.error('Error fetching gst document by id:', error);
